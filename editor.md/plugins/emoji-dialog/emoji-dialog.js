...
(function() {
	...
	var factory = function (exports) {
      ...
      exports.emoji.path = path + "emojis/";
			...
			var category = ["Peple", "Nature", "Objects", "Places", "Symbols"]
        ...
        var $tab  = tabBoxs.eq(emojiTabIndex);
                ...
                $tab.append(pagination($data[emojiTabIndex].list, cname));
                /*
                if (emojiTabIndex === 0)
                {
